...
on finance_1.id = finance_2.ï»¿id where verification_status in ('verified','not verified') group by verification_status;
...
-- State wise and last_credit_pull_d wise loan status
 select  finance_1.addr_state,
   ...
   from finance_2
    inner join   finance_1 on finance_1.id =finance_2.ï»¿id
...
finance_1.id = finance_2.ï»¿id group by finance_1.home_ownership,finance_2.last_pymnt_d;
